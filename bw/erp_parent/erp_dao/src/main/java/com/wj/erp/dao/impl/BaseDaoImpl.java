...
public class BaseDaoImpl<T> extends HibernateDaoSupport implements IBaseDao<T>{
	...
	public List<T> getList(T t,T t2,Object param) {
		...
		return (List<T>) this.getHibernateTemplate().findByCriteria(this.getDetachedCriteria(t));
	}
	...
	public List<T> getListByPage(T t,T t2,Object param,Integer page, Integer rows) {
		...
		return (List<T>) this.getHibernateTemplate().findByCriteria(this.getDetachedCriteria(t), (page - 1) * rows, rows);
	}
