 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://cxfserver.wj.com/", wsdlLocation = "http://localhost:9090/cxf/ws/weatherService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://cxfserver.wj.com/", "WeatherServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/cxf/ws/weatherService?wsdl");
    ...
    public IWeatherService getWeatherServiceImplPort() {
        return super.getPort(new QName("http://cxfserver.wj.com/", "WeatherServiceImplPort"), IWeatherService.class);
    }
    ...
    public IWeatherService getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cxfserver.wj.com/", "WeatherServiceImplPort"), IWeatherService.class, features);
    }
